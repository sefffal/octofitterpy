...
if "juliacall" in sys.modules:
    warnings.warn(
        ...
        "Also note that OCTOFITTERPY will not be able to configure `PYTHON_JULIACALL_THREADS` or `PYTHON_JULIACALL_OPTLEVEL` for you."
    )
else:
    ...
    if os.environ.get("PYTHON_JULIACALL_THREADS", "auto") != "auto":
        warnings.warn(
            ...
            "so OCTOFITTERPY was not able to set it. You may wish to set it to `'auto'` for full use "
            "of your CPU."
        )
